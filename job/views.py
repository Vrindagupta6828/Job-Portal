...
def recruiter_signup(request):
    ...
    if request.method=='POST':
        ...
        try:
            ...
            Recruiter.objects.create(user=user,mobile=c,image=i,gender=g,company=comp,type="recruiter",status="pending")
            error="no"
        except:
            error="yes"
    d = {'error':error}
...
def add_job(request):
    ...
    if request.method=='POST':
        ...
        try:
            Job.objects.create(recruiter=r , start_date=sd , end_date=ed , title=jt , salary=sal , image=l , description=des , experience=exp, location=loc , skills=skill,creationdate=date.today() )
            error="no"
        except:
            error="yes"
    d = {'error':error}
